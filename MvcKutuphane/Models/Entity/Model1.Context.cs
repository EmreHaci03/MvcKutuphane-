...
namespace MvcKutuphane.Models.Entity
{
    ...
    public partial class DbKutuphaneEntities5 : DbContext
    {
        public DbKutuphaneEntities5()
            : base("name=DbKutuphaneEntities5")
        {
        }
        ...
        public virtual DbSet<TBL_KİTAP> TBL_KİTAP { get; set; }
        ...
        public virtual DbSet<TBL_HAKKİMİZDA> TBL_HAKKİMİZDA { get; set; }
